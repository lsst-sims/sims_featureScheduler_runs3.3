...
def main(args):
    ...
    rolling_ncycles = args.rolling_ncycles
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + "_"
    file_end = "nr_cycles_%i_v3.3_" % rolling_ncycles
...
if __name__ == "__main__":
    ...
    parser.add_argument("--survey_length", type=float, default=365.25 * 20)
    ...
    parser.add_argument("--rolling_ncycles", type=int, default=4)
