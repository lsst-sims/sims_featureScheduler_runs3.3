...
def make_rolling_footprints_phase_shift(
    fp_hp=None,
    mjd_start=60218.0,
    ...
    rolling_footprints = []
    for i in range(len(all_slopes)):
        step_func = StepSlopes(rise=all_slopes[i], t_start=all_phase_shifts[i])
...
def main(args):
    ...
    footprints = make_rolling_footprints_phase_shift(
        fp_hp=footprints_hp,
